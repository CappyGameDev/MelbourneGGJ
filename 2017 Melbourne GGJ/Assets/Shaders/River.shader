...
Shader "Shader Forge/River" {
    Properties {
        ...
        _water ("water", Color) = (0.3823529,0.121337,0.02530277,1)
...
////// Emissive:
                float3 emissive = lerp(_water.rgb,_foam.rgb,saturate(((1.0 - node_3562)*(node_7076.r*2.0+0.0))));
/// Final Color:
